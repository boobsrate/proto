...
func (x *TelegramPayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TelegramPayload) ProtoMessage() {}

func (x *TelegramPayload) ProtoReflect() protoreflect.Message {
	mi := &file_auth_v1_auth_proto_msgTypes[0]
...
// Deprecated: Use TelegramPayload.ProtoReflect.Descriptor instead.
func (*TelegramPayload) Descriptor() ([]byte, []int) {
	return file_auth_v1_auth_proto_rawDescGZIP(), []int{0}
}

func (x *TelegramPayload) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *TelegramPayload) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *TelegramPayload) GetLastName() string {
	if x != nil {
		return x.LastName
	}
	return ""
...
func (x *TelegramPayload) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *TelegramPayload) GetPhotoUrl() string {
	if x != nil {
		return x.PhotoUrl
	}
	return ""
...
func (x *TelegramPayload) GetAuthDate() string {
	if x != nil {
		return x.AuthDate
	}
	return ""
...
func (x *TelegramPayload) GetHash() string {
	if x != nil {
		return x.Hash
	}
	return ""
...
var file_auth_v1_auth_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x22, 0xc7, 0x01,
	0x0a, 0x0f, 0x54, 0x65, 0x6c, 0x65, 0x67, 0x72, 0x61, 0x6d, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61,
	...
	,
	...
	0x6f, 0x74, 0x6f, 0x55, 0x72, 0x6c, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x64, 0x5f, 0x61, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x64, 0x41, 0x74, 0x42, 0x10, 0x5a, 0x0e, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x76, 0x31,
...
var file_auth_v1_auth_proto_goTypes = []interface{}{
	(*TelegramPayload)(nil), // 0: auth.v1.TelegramPayload
